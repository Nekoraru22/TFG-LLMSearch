...
La Figura \ref{fig:prefect_dashboard} muestra una vista general del dashboard de Prefect, donde se pueden monitorizar los flujos y tareas. La Figura \ref{fig:prefect_flow_example} ilustra un ejemplo de la visualización de un flujo específico en ejecución.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{archivos/prefect_flow.png}
    \caption{Visualización de un flujo de trabajo específico en Prefect.}
    \label{fig:prefect_flow_example}
\end{figure}
